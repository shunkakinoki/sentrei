...
export const DaoboardButtonCTA: FC = () => {
  ...
  return (
    <ButtonCTA>
      <Button className="text-trueGray-50 bg-gradient-to-r from-pink-400 hover:from-pink-300 via-purple-400 hover:via-purple-300 to-indigo-500 hover:to-indigo-400 hover:border-2 border-gray-600 shadow-xl hover:scale-105">
        Enter App
      </Button>
      <Button
